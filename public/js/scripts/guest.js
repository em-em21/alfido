...
/* harmony import */ var _components_user_Alerts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/user/Alerts */ "./resources/js/components/user/Alerts.js");
...
(axios__WEBPACK_IMPORTED_MODULE_0___default().defaults.headers.common["X-Requested-With"]) = 'XMLHttpRequest'; // alerts
...
if (document.getElementById('outreachForm')) {
  var contactForm = document.getElementById('outreachForm');
  contactForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var url = e.target.getAttribute('action');

    var _map = ['name', 'email', 'message'].map(function (id) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, {
      ...
      (0,_components_user_Alerts__WEBPACK_IMPORTED_MODULE_1__.default)(r.data.msg, r.data.status);
      contactForm.reset();
      window.dispatchEvent(new CustomEvent('contact-form-submitted'));
    })["catch"](function (err) {
      (0,_components_user_Alerts__WEBPACK_IMPORTED_MODULE_1__.default)(err.response.data.msg, err.response.data.status);
    });
  });
}
/**
...
if (document.querySelector('.has-sliders')) {
  var sliders = document.querySelectorAll('.sliderrr');
  sliders.forEach(function (slider) {
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__.default(slider, {
      autoplay: {
        delay: 2500
      },
      loop: true,
...
/******/ 	__webpack_require__.O(undefined, ["css/tailwind","css/app"], () => (__webpack_require__("./resources/js/guest.js")))
