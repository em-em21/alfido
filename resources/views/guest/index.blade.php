			...
			x-data="{
				benefits: [
					...
					},
					{
						'id': 2,
						'title': '{{ __('Команда') }}',
						'descr': '{{ __('В Alfido работают специалисты из различных отраслей фундаментальных наук и бизнеса. В команде объединены аналитики Blockchain-индустрии, трейдеры, программисты, финансисты и специалисты по математическому моделированию.') }}'
					},
					{
						'id': 3,
						'title': '{{ __('Экспертиза') }}',
